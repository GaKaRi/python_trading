...
class Kiwoom(QAxWidget):
    ...
    def _set_signal_slots(self):
        ...
        #TR의 응답결과를 받도록 설정
#        self.OnReceiveTrData.connect(self._on_recive_tr_data)
    ...
    def get_price_data(self, code):
        ...
        self.tr_event_loop.exec_()#TR요청보낸후 응답 대기상태로 만드는 코드임 이후 코드는 TR에 대한 응답이 도착한 후 실행됨
        ...
        while self.has_next_tr_data:
            ...
            for key, val in self.tr_data_items():
                ohlcv[key] += val
